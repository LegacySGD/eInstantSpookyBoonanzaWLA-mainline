...
public class SpookyBoonanzaWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SpookyBoonanzaWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SpookyBoonanzaWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SpookyBoonanzaWLAIW/InitOutcome.xml").getDocumentElement();
